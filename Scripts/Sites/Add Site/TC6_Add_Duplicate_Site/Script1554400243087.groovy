...
WebUI.verifyElementPresent(findTestObject('Page_HomePage/Site/Add Duplicate Site/div_This site name already exists.'), 2)

WebUI.click(findTestObject('Page_HomePage/Site/Add Duplicate Site/button_'))
