...
for(int row = 2; row <= findTestData("Sites/TD_Sites").getRowNumbers(); row++){
	...
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input__siteName'), findTestData("Sites/TD_Sites").getValue(1,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter Address'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter Site Name_address'), findTestData("Sites/TD_Sites").getValue(2,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter City'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter Address_city'), findTestData("Sites/TD_Sites").getValue(3,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter State'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter City_state'), findTestData("Sites/TD_Sites").getValue(4,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/a_NEXT'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_NEXT_country'), findTestData("Sites/TD_Sites").getValue(5,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter ZIP Code'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter Country_ZIP'), findTestData("Sites/TD_Sites").getValue(6,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter Contact Name'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter ZIP Code_cName'), findTestData("Sites/TD_Sites").getValue(7,row))
	
	WebUI.click(findTestObject('Page_HomePage/Site/Add Site/label_Enter Location Phone Number'))
	
	WebUI.setText(findTestObject('Page_HomePage/Site/Add Site/input_Enter Contact Name_locationPhone'), findTestData("Sites/TD_Sites").getValue(8,row))
